effect effects/weapons/rocketlauncher/fly
{
	...
	emitter "firetrail4"
	{
		...
		sprite
		{
			...
			start
			{
				...
				tint { point 0.525812,0.895643,0.964896 }		//small round effect around projectile, original values 0.686275,0.556863,0.494118)
				offset { point -5,0,0 }
				rotate { box 0,1 }
			}
	...
	emitter "side_streaks4"
	{
		...
		line
		{
			...
			start
			{
				...
				size { box 6,7 }
				tint { point 0.525812,0.895643,0.964896 }		//flowery streaks effect, original values 1,0.501961,0501961
				fade { point 0 }
				offset { point -3,0,0 }
	...
	light "light"
	{
		...
		light
		{
			...
			start
			{
				size { point 500,500,500 }					//size of light emmiting field, original values 200, 200, 200
				tint { point 0.525812,0.895643,0.964896 }	//color of light field, original values 0.905882, 0.517647, 0.160784
			}
		}
	}
}
